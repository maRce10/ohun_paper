...
Inquiry calls of Spix's disc-winged bats are stereotyped signals. Most variation is found between individuals although the basic structure of a short, downward broadband frequency modulation (Fig. bat-spectro) is always shared. Template-based detection is an useful approach when there is little structural differences in the target signals. Therefore we used the function.  


```{r catalog, out.width = "100%", echo = FALSE, fig.align= "center"}

# knitr::include_graphics("./data/raw/thyroptera/Catalog_p1.jpeg")

knitr::include_graphics(normalizePath(file.path("./data/raw/thyroptera", "Catalog_p1.jpeg")))


list.files("./data/raw/thyroptera")
print(getwd())
```
