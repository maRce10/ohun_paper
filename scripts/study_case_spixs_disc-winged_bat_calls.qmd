---
title: Template-based automatic detection on Spix's disc-winged bat social calls
subtitle: ohun
...
opts_chunk$set( fig.width = 8, fig.height = 3.5, warning = FALSE)
...
### Create plot with threshold vs F score
