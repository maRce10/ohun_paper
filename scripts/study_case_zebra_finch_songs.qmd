---
title: Energy-based automatic detection on zebra finch songs
subtitle: ohun
...
knitr::opts_chunk$set(include = TRUE, eval = TRUE, warning = FALSE)
...
### Check subset with highest performance (sorted by F score)
```{r, eval = FALSE}
...
### Select the highest performance parameters based on F score
...
- Good performance on detecting zebra finch songs: F score was 0.95 for the training data set and 0.96 for the testing data 
